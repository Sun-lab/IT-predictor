...
The codes to download fastq files from SRA, align the reads, call somatic mutations, annotate the called mutations and filter out high quality somatic mutation calls. 
