...
```{r}
ggplot(data=df_top50PCs) + 
  geom_point(aes(x=topPC_TSNE1,y=topPC_TSNE2,color=KM_3),size = 0.3) + 
  guides(color = guide_legend(override.aes = list(size = 2)))
```
...
```{r}
ggplot(data=df_top50PCs) + 
  geom_point(aes(x=topPC_TSNE1,y=topPC_TSNE2,color=sf_cluster),size = 0.3) + 
  guides(color = guide_legend(override.aes = list(size = 2)))
```
...
```{r}
ggplot(data=df_top50PCs) + 
  geom_point(aes(x=topPC_TSNE1,y=topPC_TSNE2,color=KM_8),size = 0.3) + 
  guides(color = guide_legend(override.aes = list(size = 2)))
```
